...
import bgImage2 from "../../assets/heroImage/walk.jpg";
const Mainpic = () => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 sm:px-10">
        ...
        <motion.p
          ...
          viewport={{ once: true, amount: 0.3 }}
        >
          Every step you take brings you closer to spiritual peace. Walk the sacred path with devotion and faith — from the call of your heart to the House of Allah.
        </motion.p>
      </div>
    </motion.div>
  );
