...
const Arbeyene2 = () => {
  const accentColor = "#926F4B";

  const handleWhatsAppClick = () => {
    const phone = "923001234567";
    const message = encodeURIComponent("I want to buy this Iraq/Iran package");
    ...
    <div className="relative min-h-screen flex justify-center items-center bg-gradient-to-br from-green-50 via-white to-gray-100 py-20 px-6 overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <BuyNowButton onClick={handleWhatsAppClick} />

          <h2 className="text-3xl font-extrabold" style={{ color: accentColor }}>
            IRAQ Group
          </h2>
          ...
          <h2 className="text-3xl font-extrabold pt-6" style={{ color: accentColor }}>
            IRAN IRAQ Group
          </h2>
          <ul className="list-disc ml-6 text-gray-700 space-y-2">
            <li>Flights: Lahore/Karachi → Najaf → Tehran → Mashhad → Lahore/Karachi</li>
          ...
          <h3 className="text-lg font-bold mt-6" style={{ color: accentColor }}>
