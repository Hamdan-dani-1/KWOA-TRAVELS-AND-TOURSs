...
import { arbaeenPackages } from "../../JsonData/Data";
    ...
    >
      ...
      <motion.div variants={fadeUp} className="text-center mb-14">
        ...
        <p className="max-w-2xl mx-auto text-gray-600 text-sm md:text-base leading-relaxed font-secondary">
          Honor the sacred journey of Arbaeen with our exclusive pilgrimage
          packages. Walk the path of devotion from Najaf to Karbala and
          experience unity, reflection, and the spirit of sacrifice that defines
        ...
        {arbaeenPackages.map((pkg, index) => (
          <motion.div
            ...
            className={` 
              ...
              ${
                index === arbaeenPackages.length - 1
          ...
          >
            ...
            <div className="p-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="w-full py-2 rounded-xl bg-accentt hover:bg-accentt-hover text-white font-semibold font-secondary transition-all"
              >
                View Details
              </motion.button>
            </div>
